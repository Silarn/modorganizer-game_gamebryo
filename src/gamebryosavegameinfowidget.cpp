#include "game_gamebryo/gamebryosavegameinfowidget.h"
...
GamebryoSaveGameInfoWidget::GamebryoSaveGameInfoWidget(GamebryoSaveGameInfo const* info, QWidget* parent)
...
GamebryoSaveGameInfoWidget::~GamebryoSaveGameInfoWidget() { delete ui; }
