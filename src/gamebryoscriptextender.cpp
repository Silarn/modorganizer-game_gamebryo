...
QString GamebryoScriptExtender::loaderName() const { return name() + "_loader.exe"; }

QString GamebryoScriptExtender::loaderPath() const { return m_Game->gameDirectory().absoluteFilePath(loaderName()); }
...
QString GamebryoScriptExtender::getExtenderVersion() const { return m_Game->getVersion(loaderName()); }
